...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/dropdown/dropdown.scss":[function(require,module,exports) {
...
$(function () {
  ...
  $inputNumber__button.click(function () {
    var button = $(this).parent().parent().parent().parent().children(".dropdown__header").text(); //Сохраняем имя пункта списка, где произошло нажатие кнопки плюс или минус
    ...
    var index = dropdownState.arrState.indexOf(label); //Если имени в массиве нет, и если его количество больше нуля,
    ...
    if (dropdownState.arrState.length == 0) {
      ...
      if (dropdownState.name === "comfort") {
        ...
        var num = 0;
        var str = ""; //Копирование массива

        var arr = _toConsumableArray(dropdownState.arrState); //Расстановка запятых после слов


        for (var _i = 1; _i <= _lengthArr - 1; _i += 2) {
          str = arr[_i];
          str += ",";
          arr[_i] = str;
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([]).then(function(){require("components/dropdown/dropdown.js");});
