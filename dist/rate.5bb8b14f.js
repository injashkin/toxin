...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/rate/rate.scss":[function(require,module,exports) {
...
$(function () {
  $(".rating__checkbox").on("click", function () {
    var elem = $(this).parent().parent().find(".rating__checkbox"); //Удаление атрибута checked

    for (var i = 0; i < elem.length; i++) {
      $(elem[i]).attr("checked", false);
    }

    var star = []; //Установка атрибута checked нажатому элементу
    ...
    $(this).parent().parent().find(".rating__star").each(function (index) {
      if (star[index] == 1) {
        $(this).text("star");
      } else {
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([]).then(function(){require("components/rate/rate.js");});
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0], null)
//# sourceMappingURL=/rate.5bb8b14f.js.map