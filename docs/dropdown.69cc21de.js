...
$(function () {
  $(".input-number__button").on("click", function () {
    var button = $(this).parent().parent().parent().parent().children(".dropdown__header");
    ...
    console.log(label);
    $(".dropdown__header").text(header); //console.log();
...
//# sourceMappingURL=../dropdown.69cc21de.js.map